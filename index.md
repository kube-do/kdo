...
{: .note }
**KDO智能云原生平台** 是一个先进的云原生基础设施平台，极大地简化了企业应用的全生命周期管理。用户无需深入了解容器、Kubernetes 或底层复杂技术，即可快速部署、管理和运维云原生应用。
...
支持桌面 IDE、WebIDE 和 KDO智能云原生平台本身三种环境进行应用管理。开发者可在偏好的集成开发环境中完成绝大多数操作，享受流畅高效的开发体验。
...
仅需一台 Linux 机器，即可全自动化安装 KDO智能云原生平台，快速搭建企业级云原生基础设施。
...
如果你是首次使用，建议先[安装 KDO智能云原生平台](/docs/install/kdo/)。
