...
{: .note }
我们是通过[KubeKey](https://gitee.com/kube-do/docs/releases/download/latest/kubekey-v3.1.12-linux-amd64.tar.gz)安装Kubernetes平台。
...
安装好Kubernetes后，就可以去[安装KDO平台](/docs/install/kdo/)了。
