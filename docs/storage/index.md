...
4. **ConfigMap 和 Secret:** [ConfigMap](/docs/dev/configurations/configmaps/) 用于存储配置数据，而 [Secret](/docs/dev/configurations/secrets/) 用于存储敏感信息如密码。它们都可以作为环境变量或者文件挂载到 Pod 中。
